    ...
    head: [
      ...
      [
        ...
        JSON.stringify({
          ...
          keywords:
            "express, cache, redis, memcached, swr, stale-while-revalidate, stampede protection, nodejs, typescript",
          featureList: [
      ...
      [
        ...
        JSON.stringify({
          ...
          url: siteUrl,
          description:
            "Official documentation for the @express-route-cache Node.js library.",
          publisher: {
            "@type": "Person",
            name: "Yatharth Lakhate",
          },
        ...
        "/v1/": [
          ...
          },
          {
            ...
            items: [
              ...
              {
                text: "Epoch Invalidation",
                link: "/v1/guide/concepts-invalidation",
              },
              {
                text: "Stampede Protection",
                link: "/v1/guide/concepts-stampede",
              },
            ],
          },
          {
        ...
        "/": [
          ...
          },
          {
            ...
            items: [
              ...
              {
                text: "Epoch Invalidation",
                link: "/guide/concepts-invalidation",
              },
